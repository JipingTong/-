...
serial_mc601 = serial_connection
...
class LimitSwitch:
    ...
    def clicked(self):
        serial_mc601.write(self.cmd_data)
        response = serial_mc601.read()  # 77 68 01 00 0D 0A
        # print(response)
...
class Light:
    ...
    def light_off(self):
        cmd_servo_data1 = bytes.fromhex('77 68 08 00 02 3B {} 00 00 00 00 0A'.format(self.port_str))
        cmd_servo_data = cmd_servo_data1
        serial_mc601.write(cmd_servo_data)
...
if __name__ == '__main__':
    ...
    servo1 = Servo(1)
    servo2 = Servo(2)
    ultr_sensor = UltrasonicSensor(3)
    servo3 = Servo_pwm(1)
    servo4 = Servo_pwm(2)
    ...
    while True:
        ...
        # key_value  = on_off_button.clicked()
        # print(">>distance=", distance, "  >>key_value=", key_value)
        print(">>distance=", distance)
        
        time.sleep(1.5)
        # servo3.servo_control(140, 80)
        # time.sleep(1)
        # servo3.servo_control(50, 80)
        # time.sleep(1)
        # testlight.light_control(0,255,0,0)
        # time.sleep(0.4)
        # testlight.light_control(0,0,255,0)
        # time.sleep(0.4)
        # testlight.light_control(0,0,0,255)
        # time.sleep(0.4)
        # testlight.light_control(0,0,0,0)
        # time.sleep(0.4)
